...
import com.elikill58.galloraapi.universal.translation.MessagesUpdater;
...
public class BNegativityCommand extends Command {
	...
	public void execute(CommandSender sender, String[] args) {
		if (sender instanceof ProxiedPlayer && !Perm.hasPerm(NegativityAccount.get(((ProxiedPlayer) sender).getUniqueId()), Perm.ADMIN)) {
	...
	public static class TabCompleter implements Listener {
		...
		private static boolean hasAdminPermission(Connection sender) {
			return !(sender instanceof ProxiedPlayer) || Perm.hasPerm(((ProxiedPlayer) sender).getUniqueId(), Perm.ADMIN);
		}
	}
}
