package com.elikill58.galloraapi.sponge.impl.location;
...
import com.elikill58.galloraapi.sponge.impl.block.SpongeBlock;
...
public class SpongeLocation extends Location {
	...
	public SpongeLocation(com.elikill58.galloraapi.api.location.World w, double x, double y, double z) {
		super(w, x, y, z);
