...
public class SpongeItemBuilder extends ItemBuilder {
	...
	public SpongeItemBuilder(com.elikill58.galloraapi.api.entity.Player owner) {
	...
	@Override
	public ItemBuilder color(com.elikill58.galloraapi.api.colors.DyeColor color) {
		item.offer(Keys.DYE_COLOR, getColor(color));
		return this;
	}
	
	private DyeColor getColor(com.elikill58.galloraapi.api.colors.DyeColor color) {
		switch (color) {
		case GRAY:
