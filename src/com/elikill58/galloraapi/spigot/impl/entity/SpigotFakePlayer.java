...
import static com.elikill58.galloraapi.spigot.utils.PacketUtils.ENUM_PLAYER_INFO;
import static com.elikill58.galloraapi.spigot.utils.PacketUtils.getNmsClass;
...
public class SpigotFakePlayer extends AbstractEntity implements FakePlayer {
	...
	@Override
	public void hide(com.elikill58.galloraapi.api.entity.Player pl) {
		Player p = (Player) pl.getDefault();
		try {
			if(Version.getVersion().equals(Version.V1_7)) {
				getNmsClass("PacketPlayOutPlayerInfo").getMethod("removePlayer", entityPlayer.getClass())
