...
import com.elikill58.galloraapi.api.colors.ChatColor;
import com.elikill58.galloraapi.api.colors.DyeColor;
...
import com.elikill58.galloraapi.api.utils.Utils;
...
public class SpigotItemBuilder extends ItemBuilder {
    ...
    public SpigotItemBuilder(String material) {
    	this.itemStack = com.elikill58.galloraapi.spigot.utils.Utils.getItemFromString(material);
    	this.itemMeta = (itemStack.hasItemMeta() ? itemStack.getItemMeta() : Bukkit.getItemFactory().getItemMeta(itemStack.getType()));
    }
    ...
    @Override
    public com.elikill58.galloraapi.api.item.ItemStack build() {
